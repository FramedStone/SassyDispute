        ...
        <div className="bg-primary p-8 min-h-screen border border-white border-l-0 border-r-0">
          ...
          <div className="grid grid-cols-3 gap-4 ">
            <div className="col-span-2 grid grid-cols-2 gap-4">
              <div className="bg-[#2F2F32] p-8 min-h-[150px] rounded-lg">
                <p className="text-white text-lg sm:text-3xl">
                  Reward first commentors with SassyTokens
                </p>
              </div>
              <div className="bg-[#F6FF95] p-8 min-h-[150px] rounded-lg">
                <p className="text-gray-900 text-lg sm:text-3xl">
                  Improve web3 e-commerce experience
                </p>
              </div>
              <div className="bg-[#F6FF95] col-span-2 p-8 min-h-[150px] rounded-lg">
                <p className="text-gray-900 text-lg sm:text-3xl">
                  Built on top of scroll Layer 2 blockchain solutions
                </p>
              </div>
              <div className="bg-[#2F2F32] col-span-2 p-8 min-h-[150px] rounded-lg">
                <p className="text-white text-lg sm:text-3xl">
                  Reward first commentors with SassyTokens
                </p>
              </div>
            ...
            <div className="grid grid-rows-3 gap-4">
              ...
              <div className="bg-[#2F2F32] row-span-2 p-8 min-h-[150px] rounded-lg">
                <p className="text-white text-lg sm:text-3xl">
